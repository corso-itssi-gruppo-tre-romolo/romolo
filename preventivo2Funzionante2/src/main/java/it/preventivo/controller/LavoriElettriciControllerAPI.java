	...
	@RestController
	@RequestMapping("/api/lavori-elettrici")
	public class LavoriElettriciControllerAPI {
	    ...
	    @GetMapping    
	    public List getAllLavoriElettrici(Model model) {
	        ...
	        return lavori; // Nome corretto della vista
	    }
